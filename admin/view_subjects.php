...
<a href="add_subject.php" class="btn-new"> Add a Subject </a>
</div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                      ...
                      <a href="edit_subject.php?edit_subject=<?php echo $row1['id'];  ?>"> <i class="fa fa-edit mx-1"></i> </a>
                      <a href="delete_subject.php?delete_subject=<?php echo $row1['id'];  ?>"> <i class="fa fa-trash "></i> </a>
                      </div>
              </td>
              </tr>              
            </tbody>
